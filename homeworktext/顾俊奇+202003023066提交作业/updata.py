...
f = open('E:\AICode\homeworktext\顾俊奇+202003023066提交作业\customdata.txt')
...
class KNN():
    def __init__(self,k,dis_mode,samples):
        ...
        self.draw_color=['b','r','g']   #颜色
        self.draw_mark=['d','s','o']    #形状
